    ...
    <div class="w-full max-w-md p-4">
        ...
        <form action="{{ route('register.form') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input class="w-full px-3 py-2 border rounded-lg" id="username" name="username" placeholder="Username" type="text" value="{{ old('username') }}"/>
                @error('username')
            ...
            <div class="mb-4">
                ...
                <input class="w-full px-3 py-2 border rounded-lg" id="email" name="email" placeholder="Email Address" type="email" value="{{ old('email') }}"/>
                @error('email')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input class="w-full px-3 py-2 border rounded-lg" id="password" name="password" placeholder="Password" type="password"/>
                @error('password')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            <div class="mb-4">
                ...
                <input class="w-full px-3 py-2 border rounded-lg" id="confirm-password" name="password_confirmation" placeholder="Verification Password" type="password"/>
            </div>
            <div class="mb-4 text-center">
                <p class="text-gray-600">Apakah sudah memiliki akun? <a class="text-[#52B69A]" href="{{ route('login') }}">Login</a></p>
            </div>
