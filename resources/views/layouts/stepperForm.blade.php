    ...
    <main>
        ...
        <div id="stepper" class="relative mb-12 w-3/4 object-center mx-auto mt-10">
            ...
            <ol class="flex items-center w-full mb-6">
                ...
                <li class="relative flex-1 flex items-center object-center" data-step="5">
                    <div
                        class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-300 text-gray-600 font-bold">
                        5</div>
        ...
        <form id="multi-step-form" class="space-y-6 " method="POST"
            action="{{ route('addData.store', ['step' => $currentStep]) }}" x-data="{ currentSteps: 1 }">
            @csrf
                ...
                <div class="space-y-6 ">
                    ...
                    <div x-show="currentSteps === 3">
                        ...
                        {{-- <div x-data="{ selectedOption: '' }">
                            <label>
                                <input type="radio" name="permitType" value="individual" x-model="selectedOption">
                                Perorangan
                            </label>
                            <label>
                                <input type="radio" name="permitType" value="business" x-model="selectedOption">
                                Badan Usaha
                            </label>

                            <div x-show="selectedOption === 'individual'">
                                @include('user.formPerizinan.formStepper.individualPermit')
                            </div>
                            <div x-show="selectedOption === 'business'">
