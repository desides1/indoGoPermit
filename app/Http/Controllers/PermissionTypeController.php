...
use App\Http\Controllers\FormStepperController;
use App\Http\Controllers\FormStepperController as UserFormStepperController;
...
class PermissionTypeController extends Controller
{
    ...
    public function validate(Request $request)
    {
        ...
        return redirect()->action([FormStepperController::class, 'index']);
